...
public class I2c2 implements Serializable
{
    ...
    private final static long serialVersionUID = -8290082469914353915L;
     ...
     * @param warmBootEn
     */
    public I2c2(int coldBootEn, int warmBootEn) {
        super();
    ...
    public String toString() {
        ...
        sb.append(I2c2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof I2c2) == false) {
            return false;
        }
        I2c2 rhs = ((I2c2) other);
