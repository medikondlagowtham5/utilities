...
public class Pulse implements Serializable
{
    ...
    private final static long serialVersionUID = 985419963063414176L;
    ...
    public String toString() {
        ...
        sb.append(Pulse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("enable");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pulse) == false) {
            return false;
        }
        Pulse rhs = ((Pulse) other);
